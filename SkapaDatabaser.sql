...
create table studies(civic varchar(20) not null, courseId varchar(20) not null, isActive bit not null, grade varchar(5), 
...
insert into studies values('111', 'KursKodA01', '0','A')
insert into studies values('222', 'KursKodA01', '1', null)
